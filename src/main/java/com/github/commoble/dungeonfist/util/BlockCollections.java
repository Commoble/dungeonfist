...
public class BlockCollections
{
	...
	public static List<FenceBlock> WOOD_FENCES = filterRegistryBySubclass(ForgeRegistries.BLOCKS, FenceBlock.class, block->block.getDefaultState().getMaterial() == Material.WOOD);
